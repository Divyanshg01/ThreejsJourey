...
const directionalLight = new THREE.DirectionalLight(0xff3333, 0.3);
...
//this works for physical and standard material only
const rectLight = new THREE.RectAreaLight(0x4e0ff, 2, 1, 1);
scene.add(rectLight);
...
const hemiSphereLightHelper = new THREE.HemisphereLightHelper(hemiLight, 0.3);
